...
echo "=========================================="
echo "feishu-bitable-receiver 部署命令"
echo "=========================================="
...
echo "【步骤 1】上传压缩包到服务器"
echo "在本地终端执行："
echo "scp /Users/tianzeyuan/Desktop/feishu-bitable-receiver.tar.gz $SERVER_USER@$SERVER_IP:/home/cnooc/python_app/"
echo "（提示：密码为 $SERVER_PASSWORD）"
echo ""
